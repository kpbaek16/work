 ...
 */
@Controller
@RequestMapping(value = "/history/0703", produces = "text/json; charset=EUC-KR")
public class History0703SCtr {
	...
	private static final Logger logger = LoggerFactory.getLogger(History0703SCtr.class);
	...
	public ModelAndView System_Info(HttpServletRequest request) {
		...
		mav.setViewName("/history/S_His_Vvrm_01");
		return mav;
	}
