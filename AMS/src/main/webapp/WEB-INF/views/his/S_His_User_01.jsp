...
<script>
	function selectUserHisList(result){
	 	if(result!=null){
	//		console.log("test:" + JSON.stringify(result));
			...
			for(var i=0; i<result.length; i++){
				...
				$("#his_tbody div#MUI_NAME_DIV").eq(iRow).html(data.MUI_NAME); 
				$("#his_tbody div#MDI_DPTNAME_DIV").eq(iRow).html(data.MDI_DPTNAME); 
				$("#his_tbody div#TXT_MUI_JCCODE_DIV").eq(iRow).html(data.TXT_MUI_JCCODE); 
				$("#his_tbody div#TXT_HUI_LOGDATE_DIV").eq(iRow).html(data.TXT_HUI_LOGDATE); 

				$("#his_tbody div#UPD_MUI_NAME_DIV").eq(iRow).html(data.UPD_MUI_NAME); 
				$("#his_tbody div#TXT_HUI_LOGTYPE_DIV").eq(iRow).html(data.TXT_HUI_LOGTYPE); 
				$("#his_tbody div#TXT_HUI_BFR_VL_DIV").eq(iRow).html(data.TXT_HUI_BFR_VL); 
				$("#his_tbody div#TXT_HUI_AFT_VL_DIV").eq(iRow).html(data.TXT_HUI_AFT_VL); 
	...
	function fn_his_selectUserHisList(param, callback, retObj) {
		console.log("****fn_his_selectUserHisList");
	
		fc_clearRow("his_tbody");
		
		var targetUrl = "/his/0702/selectUserHisList.do";
	...
	function fn_his_User(){
		var param = {
				...
				sch_mui_name : $("#sch_tbody #sch_mui_name").val()
		};
		fn_his_selectUserHisList(param, selectUserHisList);
	}
					...
					<div class="aniinfo_search_box">
                        <table class="aniinfo_search" >
                            ...
                            <tbody id="sch_tbody">
								...
								<tr>
									<th scope="row">직원명</th>
									<td><input name="textfield" type="text" id="sch_mui_name" name="sch_mui_name" class="textfield"><label for="seach_text1"></label></td>
								</tr>
						...
						<caption>직원이력 내역</caption>
							...
							<tbody id="his_tbody">
								<tr style="display:none">
									...
									<td headers="n01 th02"><div id="MUI_NAME_DIV" data-val=''></div></td>
									<td headers="n01 th03"><div id="MDI_DPTNAME_DIV" data-val=''></div></td>
									<td headers="n01 th04"><div id="TXT_MUI_JCCODE_DIV" data-val=''></div></td>
									<td headers="n01 th05"><div id="TXT_HUI_LOGDATE_DIV" data-val=''></div></td>
									<td headers="n01 th06"><div id="UPD_MUI_NAME_DIV" data-val=''></div></td>
									<td headers="n01 th07"><div id="TXT_HUI_LOGTYPE_DIV" data-val=''></div></td>
									<td headers="n01 th08"><div id="TXT_HUI_BFR_VL_DIV" data-val=''></div></td>
									<td headers="n01 th09"><div id="TXT_HUI_AFT_VL_DIV" data-val=''></div></td>
								</tr>
								<!-- 
								<tr>
									<th scope="row" id="n02" headers="th01">2</th>
									<td headers="n02 th02">김길동</td>
									<td headers="n02 th03">동물복지과</td>
									<td headers="n02 th04"></td>
									<td headers="n02 th05">2016-08-30</td>
									<td headers="n02 th06">김길동</td>
									<td headers="n02 th07">팀변경</td>
									<td headers="n02 th08">동물원운영팀</td>
									<td headers="n02 th09">복지1과</td>
								</tr>
								<tr>
									<th scope="row" id="n03" headers="th01">3</th>
									<td headers="n03 th02">김길동</td>
									<td headers="n03 th03">동물복지과</td>
									<td headers="n03 th04"></td>
									<td headers="n03 th05">2016-08-30</td>
									<td headers="n03 th06">김길동</td>
									<td headers="n03 th07">직위변경</td>
									<td headers="n03 th08">주무관</td>
									<td headers="n03 th09">주무관2</td>
								</tr>
								<tr>
									<th scope="row" id="n04" headers="th01">4</th>
									<td headers="n04 th02">김길동</td>
									<td headers="n04 th03">동물복지과</td>
									<td headers="n04 th04"></td>
									<td headers="n04 th05">2016-08-30</td>
									<td headers="n04 th06">김길동</td>
									<td headers="n04 th07">직책변경</td>
									<td headers="n04 th08">팀장</td>
									<td headers="n04 th09">과장</td>
								</tr>
								<tr>
