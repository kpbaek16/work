...
function prc_Save() {
    ...
    if (confirm("저장 하시겠습니까 ?")) {
        form.action = "/treat/0406/InspctMgr_K10_Save.do";
        form.submit();
    }
}
function prc_delete() {
    ...
    if (confirm("삭제 하시겠습니까 ?")) {
        form.action = "/treat/0406/InspctMgr_K10_Delete.do";
        form.submit();
    }
}
//////////////////////////////////////////
		...
		<div id="contents">
			...
			<h2>본문내용</h2>
				...
				<div class="title_area">
                    <p class="contents_title">초음파검사</p>
                    <ol class="location">
				...
				<input type="hidden" id="CLS1" name="CLS1" value="CHEMP" />
					...
					<div class="aniinfo_add_box">
						...
						<table class="aniinfo_add table_view2">
						    ...
						    <tr>
						    	...
						    	<td style="text-align: left;padding-left: 10px;"><input name='JJDKEP_RSLT' type='text' class='textfield' value='${KS10INFO.JJDKEP_RSLT}'><label for='JJDKEP_RSLT'></label></td>
						    </tr>
						    <tr>
							...
							<tr>
						    	<th scope="row">검사결과/특이사항</th>
						    	<td style="text-align: left;padding-left: 10px;">${KS10INFO.JJDKEP_RSLT}</td>
						    </tr>
						    <tr>
						    	<th scope="row">첨부자료1</th>
						    	<td style="text-align: left;padding-left: 10px;" class="filebox">
