...
function AddData() {
    var bum_table = document.getElementById('KS02table'); // 테이블지정
    ...
    bum_td2.innerHTML = "<input name='JJDKSK_WAY' type='text' class='textfield' value=''><label for='JJDKSK_WAY'></label>";
    bum_td3 = document.createElement('TD');    // Td를 생성한다.
    bum_td3.innerHTML = "<input name='JJDKSK_PART' type='text' class='textfield' value=''><label for='JJDKSK_PART'></label>";
    bum_td4 = document.createElement('TD');    // Td를 생성한다.
    bum_td4.innerHTML = "<input name='JJDKSK_RSLT' type='text' class='textfield' value=''><label for='JJDKSK_RSLT'></label>";
...
function prc_Save() {
    ...
    if (confirm("저장 하시겠습니까 ?")) {
        form.action = "/treat/0406/InspctMgr_K02_Save.do";
        form.submit();
    }
}
function prc_delete() {
    ...
    if (confirm("삭제 하시겠습니까 ?")) {
        form.action = "/treat/0406/InspctMgr_K02_Delete.do";
        form.submit();
    }
}
//////////////////////////////////////////
			...
			<h2>본문내용</h2>
				...
				<div class="contents_table">
					...
					<div class="aniinfo_add_box">
						...
						<table class="aniinfo_add table_view2"  id="KS02table">
							...
							<c:forEach var="KS02INFO" items="${KS02INFO}" varStatus="st">
						    <tr id = 'tr_${KS02INFO.SEQ}'>
						    	<td>${KS02INFO.SEQ}</td>
						    	<td><input name='JJDKSK_WAY' type='text' class='textfield' value='${KS02INFO.JJDKSK_WAY}'><label for='JJDKSK_WAY'></label></td>
						    	<td><input name='JJDKSK_PART' type='text' class='textfield' value='${KS02INFO.JJDKSK_PART}'><label for='JJDKSK_PART'></label></td>
						    	<td><input name='JJDKSK_RSLT' type='text' class='textfield' value='${KS02INFO.JJDKSK_RSLT}'><label for='JJDKSK_RSLT'></label></td>
						    	<td>
									<a href='javascript:deletedata("${KS02INFO.SEQ}");' class='cancel_btn' style='width: 80px;margin-left:0px;border:solid 1px #397516;background:#4d9721;color:#fff !important;'>
										삭제
									</a>
						    	</td>
						    </tr>
						    ...
						    <tr id = 'tr_${KS02INFO.SEQ}'>
						    	<td>${KS02INFO.SEQ}</td>
						    	<td>${KS02INFO.JJDKSK_WAY}</td>
						    	<td>${KS02INFO.JJDKSK_PART}</td>
						    	<td>${KS02INFO.JJDKSK_RSLT}</td>
						    	<td></td>
						    </tr>
							</c:forEach>	
							</c:otherwise>
