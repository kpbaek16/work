...
function fn_biz_search(Biz_page){
	...
	form.action="/biz/0202/main_Manual.do";
	form.submit();
}	
		...
		<div id="contents">
			...
			<h2>본문내용</h2>
				...
				<div class="title_area">
                    <p class="contents_title">업무별 매뉴얼</p>
                    <ol class="location">
				...
				<!-- search_area -->
					...
					<div class="aniinfo_add_box">
						<c:if test="${PMS0201 == 'Y'}">
						<p><a href="javascript:fn_insBiz_Manual('1');" class="info_add_btn">추가</a></p>	
						</c:if>					
						...
						<caption>검색리스트 내역</caption>
							...
							<tbody  id="biz_tbody">
								...
								<tr>
									<th scope="row"><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.SEQ}</a></th>
									<td><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.BBI_MANUALTYPE}</a></td>
									<td class="text_left"><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.BDA_CMNT}</a></td>
									<td><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.CMN_MAK_NAME}</a></td>
									<td><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.CMN_MAK_DATE}</a></td>
									<td><a href="javascript:BizDetail('${Bizlist.BBI_DOCNO}','1');">${Bizlist.CMN_UPD_DATE}</a></td>
									<td>
										<div id="biz_btn" data-val=''>
										<c:if test="${USER_ID == Bizlist.CMN_MAK_ID or sessionScope['ss_auth_grp'] == 'SA'}">
											<a href="javascript:BizUpdate('${Bizlist.BBI_DOCNO}','1')" class="t_cha_btn">수정</a><a href="javascript:BizDel('${Bizlist.BBI_DOCNO}','1')" class="del2_btn btn_type2">삭제</a>
	            						</c:if>
	            						</div>
									</td>
								</tr>
