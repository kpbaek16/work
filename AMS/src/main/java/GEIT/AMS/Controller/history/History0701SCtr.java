 ...
 */
@Controller
@RequestMapping(value = "/history/0701", produces = "text/json; charset=EUC-KR")
public class History0701SCtr {
	...
	private static final Logger logger = LoggerFactory.getLogger(History0701SCtr.class);
	...
	public ModelAndView System_Info(HttpServletRequest request) {
		...
		mav.setViewName("/history/S_His_Ani_01");
		return mav;
	}
