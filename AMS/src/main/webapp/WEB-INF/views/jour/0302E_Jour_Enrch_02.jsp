		...
		<div id="contents">
			...
			<h2>본문내용</h2>
				...
				<div class="contents_table">
					...
					<div class="aniinfo_add_box">
						...
						<table class="aniinfo_search table_view2" >
                            ...
                            <tbody>
								...
								<tr>
									<th scope="row">구분</th><td>행동풍부화</td><th scope="row">작성일</th><td>2016-06-01</td>
								</tr>
						   </tbody>
						</table>
						...
						<table class="aniinfo_search table_remove2" >
                            ...
                            <tbody>
								...
								<tr>
									<th scope="row">구분</th><td><input name="textfield" type="text" id="table2_text4" class="textfield" value="행동풍부화"/><label for="table2_text4"></label></td>
					...
					<div class="aniinfo_add_box">
						<div class="table_title_box">
							<span class="table_title"><a href="#" id="btn_plus3"><img src="../images/btn_plus.gif" alt=""></a><a href="#" id="btn_minus3"><img src="../images/btn_minus.gif" alt=""></a>내용</span>
							<div class="sys_btn_box">
						...
						<table class="aniinfo_search table_view3" >
                            ...
                            <tbody>
								<tr>
									<th scope="row">제목</th><td>황새 풍부화</td>
								</tr>
								<tr>
									<th scope="row">목표(아이디어)</th><td>황새 풍부화 목표 및 아이디어 </td>
								</tr>
								<tr>
									<th scope="row">기간</th><td>2016-06-01 ~ 2016-06-30</td>
								</tr>
								<tr>
									<th scope="row">내용</th><td>황새 풍부화 내용</td>
								</tr>
								<tr>
									<th scope="row">종류</th><td>사회성, 인지</td>
								</tr>
								<tr>
									<th scope="row">전시무리형태</th><td>이종간 전시</td>
								</tr>
								<tr>
									<th scope="row">적용가능동물</th><td>두루미, 학 등등</td>
								</tr>						

						   </tbody>
						</table>

						<table class="aniinfo_search table_remove3" >
							<caption>내용</caption>
							<colgroup>
								<col style="width:15%;">
								<col style="width:85%;">
                            ...
                            <tbody>
								<tr>
									<th scope="row">제목</th>
									<td><input name="textfield" type="text" id="table3_text1" class="textfield" value="황새 풍부화"/><label for="table3_text1"></label></td>
								</tr>
								<tr>
									<th scope="row">목표(아이디어)</th>
									<td><input name="textfield" type="text" id="table3_text2" class="textfield" value="황새 풍부화 목표 및 아이디어"/><label for="table3_text2"></label></td>
								</tr>
								<tr>
									<th scope="row">기간</th>
									<td><input name="textfield" type="text" id="table3_text3" class="textfield" value="2016-06-01 ~ 2016-06-30"/><label for="table3_text3"></label></td>
								</tr>
								<tr>
									<th scope="row">내용</th><td><input name="textfield" type="text" id="table3_text4" class="textfield" value="황새 풍부화 내용"/><label for="table3_text4"></label></td>
								</tr>
								<tr>
									<th scope="row">종류</th><td><input name="textfield" type="text" id="table3_text5" class="textfield" value="사회성, 인지"/><label for="table3_text5"></label></td>
								</tr>
								<tr>
									<th scope="row">전시무리형태</th><td><input name="textfield" type="text" id="table3_text6" class="textfield" value="이종간 전시"/><label for="table3_text6"></label></td>
								</tr>
								<tr>
									<th scope="row">적용가능동물</th><td><input name="textfield" type="text" id="table3_text7" class="textfield" value="두루미, 학 등등"/><label for="table3_text7"></label></td>
								</tr>	
					...
					<div class="aniinfo_add_box">
						<div class="table_title_box">
							...
							<div class="sys_btn_box">
								<span class="align_right btn_hide4"><a href="#layer03" class="cha_btn layer_open">수정</a></span>
							</div>
						</div>
						<table class="aniinfo_add table_view4" >
							...
							<thead>
								<tr>
									<th scope="col" id="4th01">No</th>
									<th scope="col" id="4th02">동물사</th>
									<th scope="col" id="4th03">동물종</th>
									<th scope="col" id="4th04">기타</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th scope="row" id="4n01" headers="4th01">1</th>
									<td headers="4n01 4th02">가금사</td>
									<td headers="4n01 4th03">황새</td>
									<td headers="4n01 4th04"></td>
								</tr>
								<tr>
									<th scope="row" id="4n02" headers="4th01">2</th>
									<td headers="4n02 4th02">가금사</td>
									<td headers="4n02 4th03">두루미</td>
									<td headers="4n02 4th04"></td>
								</tr>
								<tr>
									<th scope="row" id="4n03" headers="4th01">3</th>
									<td headers="4n03 4th02">맹수사</td>
									<td headers="4n03 4th03">시베리아호랑이</td>
									<td headers="4n03 4th04"></td>
								</tr>
							</tbody>
						</table>
					...
					<div class="aniinfo_add_box">
						<div class="table_title_box">
							<span class="table_title"><a href="#" id="btn_plus5"><img src="../images/btn_plus.gif" alt=""></a><a href="#" id="btn_minus5"><img src="../images/btn_minus.gif" alt=""></a>실행리스트</span>
							<div class="sys_btn_box">
								<span class="align_right"><a href="#" class="cha_btn cha_btn_sys5">수정</a></span>
								<span class="sys_btn_area5"><a href="#" class="save_btn">저장</a><a href="#" class="cancel_btn">취소</a></span>
							</div>
						</div>
						<table class="aniinfo_add table_view5" >
							<caption>실행리스트</caption>
							<colgroup>
								<col style="width:10%;">
								<col style="width:30%;">
								<col style="width:20%;">
							...
							<thead>
								<tr>
									<th scope="col" id="5th01">No</th>
									<th scope="col" id="5th02">실행일자</th>
									<th scope="col" id="5th03">실행자</th>
									<th scope="col" id="5th04">동물반응</th>
									<th scope="col" id="5th05">관람객반응</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th scope="row" id="5n01" headers="5th01">1</th>
									<td headers="5n01 5th02">2016-06-10 10:00 ~ 12:00</td>
									<td headers="5n01 5th03">박희원</td>
									<td headers="5n01 5th04">매우좋음</td>
									<td headers="5n01 5th05">매우좋음</td>
								</tr>
								<tr>
									<th scope="row" id="5n02" headers="5th01">2</th>
									<td headers="5n02 5th02">2016-06-10 10:00 ~ 12:00</td>
									<td headers="5n02 5th03">박희원</td>
									<td headers="5n02 5th04">매우좋음</td>
									<td headers="5n02 5th05">매우좋음</td>
								</tr>
								
							</tbody>
						
						</table>
						<table class="aniinfo_search table_view5" style="margin-top:10px;" >
							<caption>실행리스트</caption>
							<colgroup>
								<col style="width:20%;">
								<col style="width:20%;">
						...
						<table class="aniinfo_add table_remove5" >
							<caption>실행리스트</caption>
							<colgroup>
								<col style="width:10%;">
								<col style="width:30%;">
							...
							<thead>
								<tr>
									<th scope="col" id="5th01_1">No</th>
									<th scope="col" id="5th02_1">실행일자</th>
									<th scope="col" id="5th03_1">실행자</th>
									<th scope="col" id="5th04_1">동물반응</th>
									<th scope="col" id="5th05_1">관람객반응</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th scope="row" id="5n01_1" headers="5th01_1">1</th>
									<td headers="5n01_1 5th02_1"><input name="textfield" type="text" id="table5_text1" class="textfield" value="2016-06-10 10:00 ~ 12:00" /><label for="table5_text1"></label></td>
									<td headers="5n01_1 5th03_1"><input name="textfield" type="text" id="table5_text2" class="textfield" value="박희원" /><label for="table5_text2"></label></td>
									<td headers="5n01_1 5th04_1"><input name="textfield" type="text" id="table5_text3" class="textfield" value="매우좋음" /><label for="table5_text3"></label></td>
									<td headers="5n01_1 5th05_1"><input name="textfield" type="text" id="table5_text4" class="textfield" value="매우좋음" /><label for="table5_text4"></label></td>
								</tr>
								<tr>
									<th scope="row" id="5n01_2" headers="5th01_1">2</th>
									<td headers="5n01_2 5th02_1"><input name="textfield" type="text" id="table5_text5" class="textfield" value="2016-06-10 10:00 ~ 12:00" /><label for="table5_text5"></label></td>
									<td headers="5n01_2 5th03_1"><input name="textfield" type="text" id="table5_text6" class="textfield" value="박희원" /><label for="table5_text6"></label></td>
									<td headers="5n01_2 5th04_1"><input name="textfield" type="text" id="table5_text7" class="textfield" value="매우좋음" /><label for="table5_text7"></label></td>
									<td headers="5n01_2 5th05_1"><input name="textfield" type="text" id="table5_text8" class="textfield" value="매우좋음" /><label for="table5_text8"></label></td>
								</tr>
							
							</tbody>
						</table>
						<table class="aniinfo_search table_remove5" style="margin-top:10px;">
							<caption>실행리스트</caption>
							<colgroup>
								<col style="width:20%;">
								<col style="width:20%;">
				...
				<div class="layer_con">
					<div class="search_box">
                        <table class="search_table" style="width:760px;" >
                            ...
                            <tr><th scope="row">검색</th><td><input name="textfield" type="text" id="popsearch_text2" class="textfield" style="width:90%"/><label for="popsearch_text2"></label></td></tr>
				...
				<div class="layer_con">
					<div class="search_box">
                        <table class="search_table" style="width:760px;" >
                            ...
                            <tr><th scope="row">검색</th><td><input name="textfield" type="text" id="popsearch_text3" class="textfield" style="width:90%"/><label for="popsearch_text3"></label></td></tr>
							<tr><th colspan="2" scope="col" class="search_btn_area"><a href="#" class="search_btn">조회</a></th></tr>
                            </tbody>
                        </table>
					</div>
					<div class="table_box">
						<table class="aniinfo_add" style="width:760px; margin-top:20px;" >
							...
							<thead>
								<tr>
									<th scope="col" id="4th01_1">No</th>
									<th scope="col" id="4th02_1">동물종</th>
									<th scope="col" id="4th03_1">동물번호</th>
									<th scope="col" id="4th04_1">동물사</th>
									<th scope="col" id="4th05_1">동물이름</th>
									<th scope="col" id="4th06_1">선택</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th scope="row" id="4n01_1" headers="4th01_1">1</th>
									<td headers="4n01_1 4th02_1">김길동</td>
									<td headers="4n01_1 4th03_1">동물복지2과</td>
									<td headers="4n01_1 4th04_1"></td>
									<td headers="4n01_1 4th05_1">과장</td>
									<td headers="4n01_1 4th06_1"><input type="checkbox" id="sel3_chk"><label for="sel3_chk"></label></td>
								</tr>
								<tr>
									<th scope="row" id="4n01_2" headers="4th01_1">2</th>
									<td headers="4n01_2 4th02_1">김길동</td>
									<td headers="4n01_2 4th03_1">동물복지2과</td>
									<td headers="4n01_2 4th04_1"></td>
									<td headers="4n01_2 4th05_1">과장</td>
									<td headers="4n01_2 4th06_1"><input type="checkbox" id="sel3_chk2"><label for="sel3_chk2"></label></td>
								</tr>
								<tr>
									<th scope="row" id="4n01_3" headers="4th01_1">3</th>
									<td headers="4n01_3 4th02_1"></td>
									<td headers="4n01_3 4th03_1"></td>
									<td headers="4n01_3 4th04_1"></td>
									<td headers="4n01_3 4th05_1"></td>
									<td headers="4n01_3 4th06_1"></td>
								</tr>
								<tr>
									<th scope="row" id="4n01_4" headers="4th01_1">4</th>
									<td headers="4n01_4 4th02_1"></td>
									<td headers="4n01_4 4th03_1"></td>
									<td headers="4n01_4 4th04_1"></td>
									<td headers="4n01_4 4th05_1"></td>
									<td headers="4n01_4 4th06_1"></td>
								</tr>
								<tr>
									<th scope="row" id="4n01_5" headers="4th01_1">5</th>
									<td headers="4n01_5 4th02_1"></td>
									<td headers="4n01_5 4th03_1"></td>
									<td headers="4n01_5 4th04_1"></td>
									<td headers="4n01_5 4th05_1"></td>
									<td headers="4n01_5 4th06_1"></td>
								</tr>
